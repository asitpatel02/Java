package CH9;
// Code Listing 9-6 pg#625

public class Telephone {

	// These constant fields hold the valid lengths of string that are formatted nad unformatted
	...
	public static boolean isFormatted(String str){
		...
		valid = str.length() == FORMATTED_LENGTH && str.charAt(0) == '(' && str.charAt(4) == ')' && str.charAt(8) == '-';
